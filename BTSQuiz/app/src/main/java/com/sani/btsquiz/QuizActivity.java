...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            // have to have -1 other will throw exception at last question
...
//            Intent intent = new Intent(QuizActivity.this, BackgroundSoundService.class);
//            startService(intent);
//        }

        images = new int[] {R.drawable.bg1,R.drawable.bg2,R.drawable.bg3,
        ...
        buttonConfirmNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int arrLen = images.length;
                Random random = new Random();
                int ranNum = random.nextInt(arrLen);

                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        checkAnswer();
                    } else { //if no option is clicked before checking
                        Toast.makeText(QuizActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                    screenView.setBackground(ContextCompat.getDrawable(getApplicationContext(),images[ranNum]));
                }
            }
        });
    }
    ...
    private void updateCountDownText() {
        ...
        if (timeLeftInMillis < 5000) {
            textViewCountDown.setTextColor(getResources().getColor(R.color.colorFalseAnswer));
        } else {
    ...
    private void showSolution() {
        ...
        rb4.setTextColor(getResources().getColor(R.color.colorFalseAnswer));
